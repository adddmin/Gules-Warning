...
$post_url = preg_replace('/^url=(.*)$/i','$1',$_SERVER["QUERY_STRING"]);//获取链接与ID

$post_url_arr = explode("|",$post_url);
$prev_url     = $post_url_arr[0];
$prev_id      = $post_url_arr[1];
$count        = get_post_meta($prev_id, 'download_count', true);
update_post_meta($prev_id, 'download_count', $count+1);
